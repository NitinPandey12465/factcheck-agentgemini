...
st.markdown("---")
st.markdown('<p style="text-align:center;color:#4b5563;font-size:0.8rem;">FactCheck Agent · Powered by Google Gemini 2.0 Flash · Built for CogCulture Assessment</p>', unsafe_allow_html=True)
